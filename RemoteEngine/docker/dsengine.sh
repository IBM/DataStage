...
STR_ADDITIONAL_USERS='  --additional-users                 Comma separated list of ids (ibm-ids for cloud; uids/usernames for cp4d) that can also pass data to remote engine besides the owner.'
