...
```
cpdctl dsjob update-job {{--project PROJECT | --project-id PROJID} | {--space SPACE | --space-id SPACEID}} {--job NAME | --name NAME | --job-id ID | --id ID} [--run-name RUNNAME] [--param PARAM] [--param-file FILENAME] [--env ENV] [--paramset NAME] [--jobrun-retention-days DAYS_NUM | --jobrun-retention-runs RUNS_NUM]
```
...
```
cpdctl dsjob jobrunclean {{--project PROJECT | --project-id PROJID} | {--space SPACE | --space-id SPACEID}} [--name NAME | --id ID] [--run-id RUNID] [--dry-run] [--threads n] [--all-spaces] [--before YYYY-MM-DD:hh:mm:ss] [--states JOBRUNSTATES]
```
...
```
cpdctl dsjob list-active-runs [--project PROJECT | --project-id PROJID] [--name NAME | --id ID] [--all-spaces] [--sort-by-time|--sort-by-jobname|--sort-by-assettype|--sort-by-duration|--sort-by-state] [--output json|file] [--file-name FILENAME] [--states JOBRUNSTATES]
```
- `project` is the name of the project.
- `project-id` is the id of the project. One of `project` or `project-id` must be specified.
- `name` is the name of the job.
...
```
cpdctl dsjob export-zip {--project PROJECT | --project-id PROJID} {--name FLOW | --id ID | --pipeline SEQFLOWNAME | --pipeline-id SEQFLOWID | --testcase TESTCASENAME | --testcase-id TESTCASEID} --file-name FILENAME [--no-secrets] [--no-deps] [--include-data-assets] [--exclude-datasets-filesets] [--include-binaries] [--enc-key ENCODING-KEY] [--include-compile-metadata]
```
...
```
cpdctl dsjob export-datastage-assets {--project PROJECT | --project-id PROJID} --file-name FILENAME [--include-data-assets] [--exclude-datasets-filesets] [--include-binaries] [--enc-key ENCODING-KEY] [--include-compile-metadata]
```
...
- `with-location` when specified, prints the location of the dataset.
