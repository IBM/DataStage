...
```
cpdctl dsjob list-ds-runs {--project PROJECT | --project-id PROJID} [--name name | --id ID] [--output file|json] [--file-name FILENAME --format csv/json] [--detail]
```
...
```
cpdctl dsjob run-pipeline {--project PROJECT | --project-id PROJID} {--name NAME | --id ID} [--job-name JOBNAME] [--description DESCRIPTION] [--version VERSION] [--run-name RUNNAME] [--param PARAM] [--param-file FILENAME] [--env ENVJSON] [--paramset PARAMSET] [--wait SEC] [--reset-cache] [--no-logs] [[--optimize] [--enable-inline] [--enable-cache] [--skip-compile] [--job-suffix SUFFIX] [--warn-limit <n>]]
```
...
```
cpdctl dsjob compile-pipeline {--project PROJECT | --project-id PROJID} {--name PIPELINE | --id PIPELINEID} [--code] [--threads <n>] [--enable-inline] [--enable-cache] [--job-suffix] 
```
...
### Get Sequential file schema definition

The following syntax provides a description of the schema definition for a sequential file in a given project.

```
cpdctl dsjob describe-seq-file {--project PROJECT | --project-id PROJID} {--name NAME} [--output json|file] [--file-name FILENAME]
```

- `project` is the name of the project.
- `project-id` is the id of the project. One of `project` or `project-id` must be specified.
- `name` is the name of the sequential file.
- `instance-id` name of the PX instance that hosts the file, ex: default_datastage_px.
- `output` specifies the format of the output. This field is optional.
- `file-name` specifies the name of the file to which the output is written. This field is optional.
...
The following syntax provides the metadata and sample data of a sequential file or a CFF file  in the given project.

```
cpdctl dsjob view-data-file {--project PROJECT | --project-id PROJID} {--name NAME} [--instance-id INSTANCEID --output json|file --file-name FILENAME --delim CHAR]
```

- `project` is the name of the project.
- `project-id` is the id of the project. One of `project` or `project-id` must be specified.
- `name` is the name of the fileset.
- `instance-id` is the px runtime instance name ex: default-datastage-px.
- `output` specifies the format of the output. This field is optional.
- `file-name` specifies the name of the file to which the output is written. This field is optional.
- `delim` a single character, when specified will be used as delimiter for the fields in each record/row.
