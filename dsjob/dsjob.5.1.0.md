...
The following syntax creates a flow in the specified project:
```
cpdctl dsjob create-connection  {{--project PROJECT | --project-id PROJID} | {--space SPACE | --space-id SPACEID}} --name NAME [--description DESCRIPTION] --datasource-type TYPE [--country COUNTRY] [--no-test] [--folder FOLDERPATH] --property-file FILENAME
```
...
```
cpdctl dsjob update-wlmparams {--project PROJECT | --project-id PROJID} --name NAME [--param NAME=VALUE...]  [--param-file FILENAME...]
```
...
```
cpdctl dsjob update-wlmresources {--project PROJECT | --project-id PROJID} --name NAME [--resource NAME=VALUE...]  [--resource-file FILENAME...]
```
- `project` is the name of the project that the message handler is created for.
- `project-id` is the id of the project. One of `project` or `project-id` must be specified.
- `name` is the name of the PX Instance, custom resource instance name, ex: ds-px-default
...
```
cpdctl dsjob update-wlmqueues {--project PROJECT | --project-id PROJID} [--queue NAME=DEFN-JSON...]  [--file-name FILENAME...] [--del-queue QUEUENAME...]
```
- `project is` the name of the project that the message handler is created for.
- `project-id` is the id of the project. One of `project` or `project-id` must be specified.
- `name` is the name of the PX Instance, custom resource instance name, ex: ds-px-default
