...
```
cpdctl dsjob git-pull {--project PROJECT | --project-id PROJID} [--repo <REPONAME>] [--in-folder <FOLDERNAME>] [--branch <BRANCH>] [--name ASSETNAME | --id ASSETID]... [--on-failure ONFAILURE] [--conflict-resolution CONFLICT-RESOLUTION] [--skip-on-replace LIST] [--hard-replace]
```
